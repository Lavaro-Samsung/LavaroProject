...
public class DBHelper  extends SQLiteOpenHelper{
    ...
    public static final String[] ALL_WORKERS_COLUMNS = {
            KEY_ID, KEY_NAME, KEY_SURNAME, KEY_PASSWORD, KEY_PHONE, KEY_ABOUT,
            KEY_CITY, KEY_EMPLOYERS_LIST, KEY_WORKEXP, KEY_JOB, KEY_SALARY,
            KEY_MAIL, KEY_EDUCATION_PLACE, KEY_EDUCATION
    };
    public static final String[] ALL_CAPITALISTS_COLUMNS = {
            KEY_ID, KEY_NAME, KEY_PASSWORD, KEY_PHONE, KEY_ABOUT, KEY_JOB, KEY_SALARY, KEY_MAIL
    };
